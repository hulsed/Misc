function [x1_prop,obj_prop]=opt_ss1(x1_res,x2_cop, beta)
...
[x1_best,obj_res,exitflag, output]=fminsearch(@objective,x0,options);



    function totalobj=objective(x1)
        
        sys_grad1=2*x1;
        obj=sys_grad1*x1;
        
        con(1)=x1+beta*x2_cop-4.0;
        con(2)=2.0-beta*x1-x2_cop;
